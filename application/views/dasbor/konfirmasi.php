					...
					<tbody>
						<tr>
							...
							<td>
								...
								<?php } // ini tuh dari tabel Header_transaksi ?>
								</select>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="number" name="jumlah_bayar" class="form-control-lg" placeholder="Jumlah Pembayaran" value="<?php if(isset($_POST['jumlah_bayar'])) { echo set_value('jumlah_bayar'); }elseif($header_transaksi->jumlah_bayar!="") { echo $header_transaksi->jumlah_bayar; }else{ echo $header_transaksi->jumlah_transaksi; } // if isset itu biar muncul datanya ?>">
							</td>
						</tr>
						<tr>
							<td>Dari Bank</td>
							<td>
								<input type="text" name="nama_bank" class="form-control" value="<?php echo $header_transaksi->nama_bank // Ini Statusnya nge update?>" placeholder="Nama Bank">
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									<button class="btn btn-primary" type="submit" name="submit"><i class="fa fa-upload"></i> Submit</button>
