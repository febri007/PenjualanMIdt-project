...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        <a href="#">
          <i class="fa fa-lock"></i> <span>PELANGGAN</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          ...
          <li><a href="<?php echo base_url('admin/pelanggan/tambah') ?>"><i class="fa fa-plus"></i> Tambah Pelanggan </a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="<?php echo base_url('admin/konfigurasi/icon') ?>"><i class="fa fa-image"></i> Konfigurasi Icon </a></li>
          <li><a href="<?php echo base_url('admin/konfigurasi/qrcode') ?>"><i class="fa fa-image"></i> Konfigurasi QR Code </a></li>
        </ul>
      </li>
