...
?>
<!-- Footer -->
<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45 center-block">
	<div class="flex-w p-b-90">
		<div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
			...
			<div>
				...
				<div class="flex-m p-t-30">
					...
					<a href="<?php echo $site->instagram ?>" class="fs-30 color1 p-r-20 fa fa-instagram"></a>
				</div>
			</div>
		</div>
		...
		<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
			...
			<ul>
				...
				<li class="p-b-9">
					<a href="https://goo.gl/ufd2Kk" class="s-text7">
						Contact Us
					</a>
				</li>
